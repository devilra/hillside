...
export default function Dashboard() {
  ...
  const handleSaveProject = async (e) => {
    ...
    formData.append(
      "amenities",
      JSON.stringify(editingProject.amenities || []),
    );
              ...
              <div className="border-t border-[#142822]/80 pt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {editingProject.galleryImages &&
                    !editingProject.galleryFiles && (
                      <div className="mt-2 text-[10px] text-slate-450 truncate">
                        Gallery size:{" "}
                        {
                          JSON.parse(editingProject.galleryImages || "[]")
                            .length
                        }{" "}
                        images
                      </div>
